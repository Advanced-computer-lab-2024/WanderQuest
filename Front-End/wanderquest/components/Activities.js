...
const Activities = (Props) => {
  ...
  <div className={styles.sortButtons}>
    <button onClick={handlesortPriceAsc}>Sort by Price (Low to High)</button>
    <button onClick={handlesortPriceDsc}>Sort by Price (High to Low)</button>
    <button onClick={handlesortRatingAsc}>Sort by Rating (Low to High)</button>
    <button onClick={handlesortRatingDsc}>Sort by Rating (High to Low)</button>
  </div>
  ...
  {activities.map((activity) => (
    <div key={activity.id} className={styles.activity}>
      ...
      <p>
        ...
        <a href={activity.locationLink} target="_blank" rel="noopener noreferrer">
          {activity.location}
        </a><br />
        <strong>Price:</strong> {activity.price} USD
      </p>
